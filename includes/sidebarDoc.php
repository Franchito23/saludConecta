...
if (!$_SESSION['activo']) {
  if ($_SESSION['id_doctor']) {
    header("Location: viewDoctor/homeDoctor.php");
  } else {
    $error = "Usted no tiene permiso para entrar";
  }
}
...
<nav class="navbarc">
    ...
    <div class="side-bar">
        ...
        <div class="menu">
            <div class="item"><a href="homeDoctor.php"><i class="fa-solid fa-house"></i>Inicio</a></div>
            <div class="item"><a href="doctorCitas.php"><i class="fa-solid fa-plus"></i>Citas pendientes</a></div>
            <div class="item"><a href="reporteDoctor.php"><i class="fa-solid fa-table-list"></i>Reporte</a></div>
